...
typedef struct 
{
    ...
    int (*display_otr_message)( const char *aname ,
                                const char *proto ,
                                const char *user  ,
                                const char *mesg  );

    OtrgDialogWaitHandle (*private_key_wait_start)( const char *acct  ,
                                                    const char *proto );

    void (*private_key_wait_done)( OtrgDialogWaitHandle handle );

    void (*unknown_fingerprint   )(OtrlUserState us  , 
                                   const char *aname ,
                                   const char *proto , 
                                   const char *who   , 
    ...
    void (*socialist_millionaires)( ConnContext *context ,
                                    char *question       ,
                                    gboolean responder   );
    ...
    void (*finished)(const char *aname, const char *proto, const char *user );
